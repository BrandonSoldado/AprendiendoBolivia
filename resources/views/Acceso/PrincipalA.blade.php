        ...
        <ul>       
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{ url('/Grupo') }}">CU3. Gestionar Grupos</a></li>
                    ...
                    <li><a href="{{ url('/MostrarHistoriales') }}">CU14. Registrar y Consultar Historiales Académicos</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{ url('/IdiomaModulo') }}">CU9. Gestionar Idiomas</a></li>
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{ url('/ConvenioA') }}">CU8. Gestionar Instituciones y Convenios</a></li>
                    <li><a href="#">CU7. Gestionar Horarios</a></li>
                    <li><a href="#">CU20. Control de Caducidad de Inscripciones</a></li>
                    <li><a href="{{ url('/Bitacora') }}">CU23. Gestionar Bitácora de Actividades</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{ url('/MostrarCodigosQr') }}">CU21. Registrar Código QR</a></li>
