        ...
        <ul>       
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{ url('/MostrarPAT') }}">CU4. Gestionar Asistencias</a></li>
                    <li><a href="{{ url('/MostrarPAT') }}">CU5. Gestionar Avances Académicos</a></li>
                    <li><a href="{{ url('/MostrarPAT') }}">CU6. Gestionar Parciales</a></li>
